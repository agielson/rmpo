...
public class widgetConfigureActivity extends Activity {
    ...
    View.OnClickListener list =new View.OnClickListener() {
        public void onClick(View v) {
            ...
            editor.putString(PREF_COLOR+String.valueOf(mAppWidgetId),color);
    ...
    public void onCreate(Bundle icicle) {
        ...
        binding.imageButtonBlue.setOnClickListener(list);
        binding.imageButtonRed.setOnClickListener(list);
        binding.imageButtonPer.setOnClickListener(list);
        binding.imageButtonGreen.setOnClickListener(list);
